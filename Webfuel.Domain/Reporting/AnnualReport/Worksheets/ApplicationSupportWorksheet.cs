...
internal class ApplicationSupportWorksheet : AnnualReportWorksheet
{
    ...
    public async Task RenderProject(IServiceProvider serviceProvider, AnnualReportContext context, Project project)
    {
        ...
        SetValue(NewcastleUniversity, project.RSSHubProvidingAdviceIds.Contains(RSSHubEnum.NewcastleUniversityAndPartners));
        SetValue(UniversityOfBirmingham, project.RSSHubProvidingAdviceIds.Contains(RSSHubEnum.UniversityOfBirminghamAndPartners));
        SetValue(UniversityOfLancaster, project.RSSHubProvidingAdviceIds.Contains(RSSHubEnum.UniversityOfLancasterAndPartners));
        SetValue(UniversityOfYork, project.RSSHubProvidingAdviceIds.Contains(RSSHubEnum.UniversityOfYorkAndPartners));
        SetValue(ImperialCollegeLondon, true);
        SetValue(UniversityOfSouthampon, project.RSSHubProvidingAdviceIds.Contains(RSSHubEnum.UniversityOfSouthamptonAndPartners));
        SetValue(KingsCollegeLondon, project.RSSHubProvidingAdviceIds.Contains(RSSHubEnum.KingsCollegeLondonAndPartners));
        SetValue(UniversityOfLeicester, project.RSSHubProvidingAdviceIds.Contains(RSSHubEnum.UniversityOfLeicesterAndPartners));
        SetValue(SpecialistsCentreUniveristyOfSouthampton, project.RSSHubProvidingAdviceIds.Contains(RSSHubEnum.SouthamptonAndPartnersPublicHealthSpecialistCentre));
        SetValue(SpecialistCentreNewcastleUniversity, project.RSSHubProvidingAdviceIds.Contains(RSSHubEnum.NewcastleAndPartnersPublicHealthSpecialistCentre));
        SetValue(SpecialistCentreLancasterUniversity, project.RSSHubProvidingAdviceIds.Contains(RSSHubEnum.LancasterUniversityAndPartnersSocialCareSpecialistCentre));
