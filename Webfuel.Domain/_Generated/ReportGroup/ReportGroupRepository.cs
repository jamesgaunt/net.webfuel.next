...
namespace Webfuel.Domain
{
    internal partial interface IReportGroupRepository
    {
        ...
        Task<QueryResult<ReportGroup>> QueryReportGroup(Query query);
    ...
    internal partial class ReportGroupRepository: IReportGroupRepository
    {
        ...
        public async Task<QueryResult<ReportGroup>> QueryReportGroup(Query query)
        {
            return await _connection.ExecuteQuery<ReportGroup, ReportGroupMetadata>(query);
        }
