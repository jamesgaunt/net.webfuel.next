...
import { Project, SupportRequest } from '../../../api/api.types';
import { SupportRequestApi } from '../../../api/support-request.api';
import { StaticDataCache } from '../../../api/static-data.cache';
import { FormService } from '../../../core/form.service';
import { DialogService } from '../../../core/dialog.service';
import { SupportRequestTriageDialogComponent, SupportRequestTriageDialogOptions } from '../support-request-triage-dialog/support-request-triage-dialog.component';
...
export class SupportRequestItemComponent implements OnInit {
  ...
  constructor(
    ...
    private diaogService: DialogService,
  ...
  triage() {
    this.diaogService.open<Project | null, SupportRequestTriageDialogOptions>(SupportRequestTriageDialogComponent, {
      data: {
        id: this.item.id
      }
    })
