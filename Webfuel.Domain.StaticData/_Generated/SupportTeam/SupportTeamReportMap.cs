...
{
    [Service(typeof(IReportMap<SupportTeam>))]
    internal class SupportTeamReportMap : IReportMap<SupportTeam>
    {
        private readonly ISupportTeamRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public SupportTeamReportMap(ISupportTeamRepository repository, IStaticDataCache staticDataCache)
        {
