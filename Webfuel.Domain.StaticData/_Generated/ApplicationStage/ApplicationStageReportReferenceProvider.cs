...
{
    [Service(typeof(IReportReferenceProvider<ApplicationStage>))]
    internal class ApplicationStageReportReferenceProvider : IReportReferenceProvider<ApplicationStage>
    {
        private readonly IApplicationStageRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public ApplicationStageReportReferenceProvider(IApplicationStageRepository repository, IStaticDataCache staticDataCache)
        {
        ...
        public async Task<ReportReference?> Get(Guid id)
        {
            ...
            var entity = staticData.ApplicationStage.FirstOrDefault(x => x.Id == id);
