...
{
    [Service(typeof(IReportMap<Gender>))]
    internal class GenderReportMap : IReportMap<Gender>
    {
        private readonly IGenderRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public GenderReportMap(IGenderRepository repository, IStaticDataCache staticDataCache)
        {
