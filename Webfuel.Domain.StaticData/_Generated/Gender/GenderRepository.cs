...
namespace Webfuel.Domain.StaticData
{
    internal partial interface IGenderRepository
    {
        ...
        Task<QueryResult<Gender>> QueryGender(Query query, bool selectItems = true, bool countTotal = true);
    ...
    internal partial class GenderRepository: IGenderRepository
    {
        ...
        public async Task<QueryResult<Gender>> QueryGender(Query query, bool selectItems = true, bool countTotal = true)
        {
            return await _connection.ExecuteQuery<Gender, GenderMetadata>(query, selectItems: selectItems, countTotal: countTotal);
        }
