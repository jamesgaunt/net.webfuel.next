...
{
    [Service(typeof(IReportReferenceProvider<Gender>))]
    internal class GenderReportReferenceProvider : IReportReferenceProvider<Gender>
    {
        private readonly IGenderRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public GenderReportReferenceProvider(IGenderRepository repository, IStaticDataCache staticDataCache)
        {
        ...
        public async Task<ReportReference?> Get(Guid id)
        {
            ...
            var entity = staticData.Gender.FirstOrDefault(x => x.Id == id);
