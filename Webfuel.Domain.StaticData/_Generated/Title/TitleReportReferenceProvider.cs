...
{
    [Service(typeof(IReportReferenceProvider<Title>))]
    internal class TitleReportReferenceProvider : IReportReferenceProvider<Title>
    {
        private readonly ITitleRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public TitleReportReferenceProvider(ITitleRepository repository, IStaticDataCache staticDataCache)
        {
        ...
        public async Task<ReportReference?> Get(Guid id)
        {
            ...
            var entity = staticData.Title.FirstOrDefault(x => x.Id == id);
