...
{
    [Service(typeof(IReportMap<Ethnicity>))]
    internal class EthnicityReportMap : IReportMap<Ethnicity>
    {
        private readonly IEthnicityRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public EthnicityReportMap(IEthnicityRepository repository, IStaticDataCache staticDataCache)
        {
        ...
        {
            query.Contains(nameof(Ethnicity.Name), query.Search);
