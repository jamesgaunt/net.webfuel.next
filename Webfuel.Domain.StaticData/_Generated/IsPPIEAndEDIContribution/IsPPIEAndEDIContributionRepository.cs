...
namespace Webfuel.Domain.StaticData
{
    ...
    {
        Task<QueryResult<IsPPIEAndEDIContribution>> QueryIsPPIEAndEDIContribution(Query query, bool selectItems = true, bool countTotal = true);
    ...
    internal partial class IsPPIEAndEDIContributionRepository: IIsPPIEAndEDIContributionRepository
    {
        ...
        public async Task<QueryResult<IsPPIEAndEDIContribution>> QueryIsPPIEAndEDIContribution(Query query, bool selectItems = true, bool countTotal = true)
        {
            return await _connection.ExecuteQuery<IsPPIEAndEDIContribution, IsPPIEAndEDIContributionMetadata>(query, selectItems: selectItems, countTotal: countTotal);
        }
