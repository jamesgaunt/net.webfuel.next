...
{
    [Service(typeof(IReportMap<IsPPIEAndEDIContribution>))]
    internal class IsPPIEAndEDIContributionReportMap : IReportMap<IsPPIEAndEDIContribution>
    {
        private readonly IIsPPIEAndEDIContributionRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public IsPPIEAndEDIContributionReportMap(IIsPPIEAndEDIContributionRepository repository, IStaticDataCache staticDataCache)
        {
        ...
        {
            query.Contains(nameof(IsPPIEAndEDIContribution.Name), query.Search);
