...
{
    [Service(typeof(IReportReferenceProvider<IsFellowship>))]
    internal class IsFellowshipReportReferenceProvider : IReportReferenceProvider<IsFellowship>
    {
        private readonly IIsFellowshipRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public IsFellowshipReportReferenceProvider(IIsFellowshipRepository repository, IStaticDataCache staticDataCache)
        {
        ...
        public async Task<ReportReference?> Get(Guid id)
        {
            ...
            var entity = staticData.IsFellowship.FirstOrDefault(x => x.Id == id);
