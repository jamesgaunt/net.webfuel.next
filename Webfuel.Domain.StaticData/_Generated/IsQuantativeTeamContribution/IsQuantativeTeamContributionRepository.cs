...
namespace Webfuel.Domain.StaticData
{
    ...
    {
        Task<QueryResult<IsQuantativeTeamContribution>> QueryIsQuantativeTeamContribution(Query query, bool selectItems = true, bool countTotal = true);
    ...
    internal partial class IsQuantativeTeamContributionRepository: IIsQuantativeTeamContributionRepository
    {
        ...
        public async Task<QueryResult<IsQuantativeTeamContribution>> QueryIsQuantativeTeamContribution(Query query, bool selectItems = true, bool countTotal = true)
        {
            return await _connection.ExecuteQuery<IsQuantativeTeamContribution, IsQuantativeTeamContributionMetadata>(query, selectItems: selectItems, countTotal: countTotal);
        }
