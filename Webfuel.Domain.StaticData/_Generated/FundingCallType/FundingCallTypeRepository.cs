...
namespace Webfuel.Domain.StaticData
{
    internal partial interface IFundingCallTypeRepository
    {
        ...
        Task<QueryResult<FundingCallType>> QueryFundingCallType(Query query, bool selectItems = true, bool countTotal = true);
    ...
    internal partial class FundingCallTypeRepository: IFundingCallTypeRepository
    {
        ...
        public async Task<QueryResult<FundingCallType>> QueryFundingCallType(Query query, bool selectItems = true, bool countTotal = true)
        {
            return await _connection.ExecuteQuery<FundingCallType, FundingCallTypeMetadata>(query, selectItems: selectItems, countTotal: countTotal);
        }
