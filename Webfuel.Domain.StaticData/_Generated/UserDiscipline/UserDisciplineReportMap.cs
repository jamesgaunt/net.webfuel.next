...
{
    [Service(typeof(IReportMap<UserDiscipline>))]
    internal class UserDisciplineReportMap : IReportMap<UserDiscipline>
    {
        private readonly IUserDisciplineRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public UserDisciplineReportMap(IUserDisciplineRepository repository, IStaticDataCache staticDataCache)
        {
