...
namespace Webfuel.Domain.StaticData
{
    internal partial interface ISiteRepository
    {
        ...
        Task<QueryResult<Site>> QuerySite(Query query, bool selectItems = true, bool countTotal = true);
    ...
    internal partial class SiteRepository: ISiteRepository
    {
        ...
        public async Task<QueryResult<Site>> QuerySite(Query query, bool selectItems = true, bool countTotal = true)
        {
            return await _connection.ExecuteQuery<Site, SiteMetadata>(query, selectItems: selectItems, countTotal: countTotal);
        }
