...
{
    [Service(typeof(IReportReferenceProvider<SubmissionStage>))]
    internal class SubmissionStageReportReferenceProvider : IReportReferenceProvider<SubmissionStage>
    {
        private readonly ISubmissionStageRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public SubmissionStageReportReferenceProvider(ISubmissionStageRepository repository, IStaticDataCache staticDataCache)
        {
        ...
        public async Task<ReportReference?> Get(Guid id)
        {
            ...
            var entity = staticData.SubmissionStage.FirstOrDefault(x => x.Id == id);
