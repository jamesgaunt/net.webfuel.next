...
namespace Webfuel.Domain.StaticData
{
    ...
    {
        Task<QueryResult<IsTeamMembersConsulted>> QueryIsTeamMembersConsulted(Query query, bool selectItems = true, bool countTotal = true);
    ...
    internal partial class IsTeamMembersConsultedRepository: IIsTeamMembersConsultedRepository
    {
        ...
        public async Task<QueryResult<IsTeamMembersConsulted>> QueryIsTeamMembersConsulted(Query query, bool selectItems = true, bool countTotal = true)
        {
            return await _connection.ExecuteQuery<IsTeamMembersConsulted, IsTeamMembersConsultedMetadata>(query, selectItems: selectItems, countTotal: countTotal);
        }
