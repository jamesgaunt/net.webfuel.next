...
{
    public partial class IsTeamMembersConsulted: IStaticData
    {
        public IsTeamMembersConsulted() { }
        
        public IsTeamMembersConsulted(SqlDataReader dr)
        {
        ...
        public IsTeamMembersConsulted Copy()
        {
            var entity = new IsTeamMembersConsulted();
            entity.Id = Id;
            entity.Name = Name;
