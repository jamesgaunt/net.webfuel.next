...
{
    [Service(typeof(IReportMap<IsTeamMembersConsulted>))]
    internal class IsTeamMembersConsultedReportMap : IReportMap<IsTeamMembersConsulted>
    {
        private readonly IIsTeamMembersConsultedRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public IsTeamMembersConsultedReportMap(IIsTeamMembersConsultedRepository repository, IStaticDataCache staticDataCache)
        {
