...
{
    [Service(typeof(IReportMapper<IsCTUAlreadyInvolved>))]
    internal class IsCTUAlreadyInvolvedReportMapper : IReportMapper<IsCTUAlreadyInvolved>
    {
        private readonly IIsCTUAlreadyInvolvedRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public IsCTUAlreadyInvolvedReportMapper(IIsCTUAlreadyInvolvedRepository repository, IStaticDataCache staticDataCache)
        {
