...
namespace Webfuel.Domain.StaticData
{
    public partial class ProjectStatusMetadata: IRepositoryMetadata<ProjectStatus>
    {
            ...
            foreach(var property in properties)
            {
                switch (property)
                {
                    ...
                    case nameof(ProjectStatus.FreeText):
                        result.Add(new SqlParameter(nameof(ProjectStatus.FreeText), entity.FreeText));
                        break;
                }
            }
            return result;
        ...
        public class ProjectStatusRepositoryValidator: AbstractValidator<ProjectStatus>
        {
