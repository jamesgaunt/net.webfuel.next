...
{
    [Service(typeof(IReportReferenceProvider<ReportProvider>))]
    internal class ReportProviderReportReferenceProvider : IReportReferenceProvider<ReportProvider>
    {
        private readonly IReportProviderRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public ReportProviderReportReferenceProvider(IReportProviderRepository repository, IStaticDataCache staticDataCache)
        {
        ...
        public async Task<ReportReference?> Get(Guid id)
        {
            ...
            var entity = staticData.ReportProvider.FirstOrDefault(x => x.Id == id);
