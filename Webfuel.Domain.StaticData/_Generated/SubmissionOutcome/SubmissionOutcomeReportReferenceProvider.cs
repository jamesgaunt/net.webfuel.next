...
{
    [Service(typeof(IReportReferenceProvider<SubmissionOutcome>))]
    internal class SubmissionOutcomeReportReferenceProvider : IReportReferenceProvider<SubmissionOutcome>
    {
        private readonly ISubmissionOutcomeRepository _repository;
        private readonly IStaticDataCache _staticDataCache;
        
        public SubmissionOutcomeReportReferenceProvider(ISubmissionOutcomeRepository repository, IStaticDataCache staticDataCache)
        {
        ...
        public async Task<ReportReference?> Get(Guid id)
        {
            ...
            var entity = staticData.SubmissionOutcome.FirstOrDefault(x => x.Id == id);
