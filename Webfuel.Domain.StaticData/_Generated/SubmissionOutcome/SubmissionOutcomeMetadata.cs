...
namespace Webfuel.Domain.StaticData
{
    ...
    public partial class SubmissionOutcomeRepositoryValidator: AbstractValidator<SubmissionOutcome>
    {
        public SubmissionOutcomeRepositoryValidator()
        {
            RuleFor(x => x.Name).Use(SubmissionOutcomeMetadata.Name_ValidationRules);
            Validation();
        }
