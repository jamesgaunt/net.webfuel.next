...
namespace Webfuel.Common
{
    internal partial interface IActivityLogRepository
    {
        ...
        Task<QueryResult<ActivityLog>> QueryActivityLog(Query query, bool selectItems = true, bool countTotal = true);
    ...
    internal partial class ActivityLogRepository: IActivityLogRepository
    {
        ...
        public async Task<QueryResult<ActivityLog>> QueryActivityLog(Query query, bool selectItems = true, bool countTotal = true)
        {
            return await _connection.ExecuteQuery<ActivityLog, ActivityLogMetadata>(query, selectItems: selectItems, countTotal: countTotal);
        }
