...
public static class FileStorageEntryApi
{
    public static void RegisterEndpoints(IEndpointRouteBuilder app)
    {
        ...
        app.MapPost("api/file-storage-entry/update", Update)
             .RequireIdentity();
    ...
    public static async Task<FileStorageEntry> Update([FromBody] UpdateFileStorageEntry command, IFileStorageService fileStorageService)
    {
        return await fileStorageService.UpdateFile(command);
    }
